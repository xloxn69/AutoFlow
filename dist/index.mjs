...
function useWorkflowLinting(nodes, edges, options = {}) {
  ...
  const lintWorkflow = useCallback(async (workflowNodes, workflowEdges) => {
  ...
  const debouncedLint = useCallback((workflowNodes, workflowEdges) => {
  ...
  const getEdgeIssues = useCallback((edgeId) => {
    if (!result) return [];
